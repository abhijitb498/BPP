...
aa = 3.0
bb = 12.0 !! As solve uses BISECTION METHOD, you need to provide to initial points, 1st one is rho0, 2nd one is > rho0
call solve(aa,bb,rho0,sm,z,kl,ss,Ecm1)
!write(*,*)rho0
!print*, "Barrier at rho0 = ", rho0, "is", Vcoulcf(rho0,sm,z,kl,ss)
...
!call hyperradius1(m, sm, th, rad, rho0, s0)
